  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "${widget.billType.titleCase} Bills",
        ...
        children: List.generate(
          ...
          (index) {
            ...
            return PropertyExpansionTile(
              ...
              amount: data.amount!,
              tax: data.tax!,
              propertyName: data.tenant_rental_record!.property!.property_name!,
            ...
            //         Wrap(
            //           children: List.generate(
            //             data.uploaded_reference_doc!.length,
            //             (index2) => Image.network(
            //               ApiUrls.domain +
            //                   data.uploaded_reference_doc!
            //                       .elementAt(index2)
            //                       .file,
            ...
            Wrap(
              children: List.generate(
                ...
                (index2) => Container(
                  ...
                  child: Image.network(
                    ApiUrls.domain +
                        widget.uploadedFiles.elementAt(index2).file,
                    height: context.deviceHeight * 0.2,
                  ),
                ),
              ),
